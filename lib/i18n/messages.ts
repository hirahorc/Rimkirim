...
const id = {
  ...
  order: {
    ...
    packingListPending:
      "Dibuat otomatis setelah dua bagian pertama selesai.",
    packingListReady: "Sudah dibuat",
    generatePdf: "Unduh PDF",
    generatePdfNote: "Aktif setelah dua bagian pertama tersimpan.",
...
const en: Messages = {
  ...
  order: {
    ...
    packingListTitle: "Packing List",
    packingListPending:
      "Created automatically once the first two sections are complete.",
    packingListReady: "Created",
    generatePdf: "Download PDF",
    generatePdfNote: "Available once the first two sections are saved.",
