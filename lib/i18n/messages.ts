...
const id = {
  ...
  order: {
    ...
    clPersonalTax: "Bebas pajak untuk barang bekas pribadi",
    clPersonalValueCap: "Tidak ada batas",
    clPersonalSkp: "Wajib",
    clPersonalWindow: "90 hari sebelum sampai 90 hari setelah kamu tiba",
    clPersonalDocs:
      "Tiket pesawat / boarding pass, SKP, dan bukti studi atau kerja di luar negeri",
    clPassengerTax: "Bebas pajak sampai USD 500, sisanya kena pajak",
    clPassengerValueCap: "USD 500 per orang",
...
const en: Messages = {
  ...
  order: {
    ...
    clPersonalTax: "Tax-free for used personal items",
    clPersonalValueCap: "No limit",
    clPersonalSkp: "Required",
    clPersonalWindow: "90 days before to 90 days after you arrive",
    clPersonalDocs:
      "Flight ticket / boarding pass, SKP, and proof of study or work abroad",
    clPassengerTax: "Tax-free up to USD 500, the rest is taxed",
    clPassengerValueCap: "USD 500 per person",
