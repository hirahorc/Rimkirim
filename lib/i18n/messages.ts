...
const id = {
  ...
  order: {
    ...
    qPerKg: "/ kg",
    qIneligibleInline: "Kami arahkan kamu ke tim untuk jenis kiriman lain.",
    qForeignerInline: "Kami arahkan kamu ke layanan relokasi WNA.",
...
const en: Messages = {
  ...
  order: {
    ...
    qPerKg: "/ kg",
    qIneligibleInline: "We'll point you to our team for other kinds of shipment.",
    qForeignerInline: "We'll take you to the expat relocation service.",
