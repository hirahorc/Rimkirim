...
const id = {
  ...
  order: {
    ...
    clOneWay: "Jalur tidak bisa diubah setelah lanjut. Pastikan dulu sebelum menekan tombol.",
    ...
    clRowDocs: "Dokumen yang perlu disiapkan",
    clPersonalTax: "Bebas pajak",
    ...
    clPersonalWindow: "90 hari sebelum sampai 90 hari setelah kamu tiba",
    clPersonalWindowNote: "dihitung dari tanggal kedatanganmu",
    clPersonalDocs: "Tiket pesawat / boarding pass|SKP|Bukti studi atau kerja di luar negeri",
    clPassengerTax: "Bebas pajak sampai batas nilai",
    ...
    clPassengerSkpNote: "cukup tiket",
    clPassengerWindow: "30 hari sebelum sampai 15 hari setelah kamu tiba",
    clPassengerWindowNote: "dihitung dari tanggal kedatanganmu",
...
const en: Messages = {
  ...
  order: {
    ...
    clOneWay: "The route can't be changed after this step. Make sure before you continue.",
    ...
    clRowDocs: "Documents to prepare",
    clPersonalTax: "Tax-free",
    ...
    clPersonalWindow: "90 days before to 90 days after you arrive",
    clPersonalWindowNote: "counted from your arrival date",
    clPersonalDocs: "Flight ticket / boarding pass|SKP|Proof of study or work abroad",
    clPassengerTax: "Tax-free up to the value limit",
    ...
    clPassengerWindow: "30 days before to 15 days after you arrive",
    clPassengerWindowNote: "counted from your arrival date",
