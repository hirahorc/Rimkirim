...
const id = {
  ...
  order: {
    ...
    clCompareLabel: "Perbandingan kedua jalur",
    ...
    clRowWindow: "Rentang waktu kedatangan barang",
    ...
    clPassengerTaxNote: "kelebihannya kena pajak",
    ...
    clLockedLived: "kamu tinggal di luar negeri kurang dari 12 bulan",
...
const en: Messages = {
  ...
  order: {
    ...
    clCompareLabel: "Comparison of both routes",
    ...
    clRowWindow: "Arrival window for your goods",
    ...
    clPassengerTaxNote: "anything above it is taxed",
    clPassengerValueCap: "USD 500",
    ...
    clLockedLived: "you lived abroad for less than 12 months",
