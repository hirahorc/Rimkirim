...
const id = {
  ...
  order: {
    ...
    qRoutingNote: "Menentukan jalur bea cukai",
    qGateNote: "Syarat layanan",
    qOptionalNote: "Punya kode? · mempercepat formulir",
    qProgress: "{n} dari {max} dijawab",
    qEligibleReadout: "Memenuhi syarat · jalur bea cukai ditentukan di langkah berikutnya",
    qPerKg: "/ kg",
    qIneligibleInline: "Back For Good khusus barang pribadi. Kami arahkan kamu ke tim untuk jenis kiriman lain.",
    qForeignerInline: "Untuk WNA, Rimkirim punya layanan relokasi khusus. Kami arahkan kamu ke sana.",
    qSeeOptions: "Lihat opsi lain",
    qToExpat: "Ke relokasi WNA",
    ...
    clRowWindow: "Jendela kedatangan barang",
    clRowDocs: "Dokumen yang disiapkan",
    ...
    clPersonalWindow: "90 hari sebelum sampai 90 hari setelah",
    clPersonalWindowNote: "kamu tiba di Indonesia",
    ...
    clPassengerSkpNote: "",
    clPassengerWindow: "30 hari sebelum sampai 15 hari setelah",
    clPassengerWindowNote: "kamu tiba di Indonesia",
...
const en: Messages = {
  ...
  order: {
    ...
    qRoutingNote: "Decides the customs route",
    qGateNote: "Service requirement",
    qOptionalNote: "Have a code? · speeds up the form",
    qProgress: "{n} of {max} answered",
    qEligibleReadout: "Eligible · your customs route is decided in the next step",
    qPerKg: "/ kg",
    qIneligibleInline: "Back For Good is for personal belongings only. We'll point you to our team for other shipments.",
    qForeignerInline: "For foreign nationals, Rimkirim has a dedicated relocation service. We'll take you there.",
    qSeeOptions: "See other options",
    qToExpat: "Go to expat relocation",
    ...
    clPersonalWindow: "90 days before to 90 days after",
    clPersonalWindowNote: "you arrive in Indonesia",
    ...
    clPassengerSkpNote: "",
    clPassengerWindow: "30 days before to 15 days after",
    clPassengerWindowNote: "you arrive in Indonesia",
