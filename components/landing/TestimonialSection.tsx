        ...
        >
          ...
          {rest.map(({ name, quote, origin, affiliation, highlights }) => (
            <Card
              ...
              className="testi-card flex w-[78%] shrink-0 snap-start scroll-mt-24 break-inside-avoid flex-col rounded-lg px-6 py-7 transition-colors hover:border-border-strong sm:mb-4 sm:w-auto sm:shrink"
            >
